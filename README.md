...
Note that the base import path is `gopkg.in/launchdarkly/go-server-sdk-core.v2` (to ensure that you receive the latest release of major version 1.x), not `github.com/launchdarkly/go-server-sdk-core`.
